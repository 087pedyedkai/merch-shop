  ...
  if (!existingProducts) {
    const testProducts = [
      ...
      },
      {
        ...
        description: 'กระเป๋าสะพายข้างสีดำ มีโลโก้วิทยาการคอมพิวเตอร์ ใส่ของได้เยอะ วัสดุทนทาน เหมาะสำหรับนักศึกษา',
        price: 450,
      ...
      },
      {
        ...
        description: 'แก้วน้ำสแตนเลส รักษาอุณหภูมิได้ดี มีโลโก้วิทยาการคอมพิวเตอร์ ความจุ 500ml เหมาะสำหรับพกพา',
        price: 250,
